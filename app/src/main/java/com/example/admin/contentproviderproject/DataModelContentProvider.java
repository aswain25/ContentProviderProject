...
public class DataModelContentProvider extends ContentProvider
{
    private LocalDataSource<DataModel> dbHelper;
    ...
    private static final String AUTHORITY = "datamodelcontentprovider";
    ...
    public boolean onCreate() {
        ...
        dbHelper = new LocalDataSource<DataModel>(getContext(), DataModel.Contract);
        return false;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_COUNTRY:
                ...
                queryBuilder.appendWhere(dbHelper.primaryKeyName + "=" + id);
                break;
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_COUNTRY:
                String id = uri.getPathSegments().get(1);
                selection = dbHelper.primaryKeyName + "=" + id
        ...
        int deleteCount = db.delete(dbHelper.TABLE, selection, selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return deleteCount;
    }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int updateCount = db.update(dbHelper.TABLE, values, selection, selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return updateCount;
    }
}
